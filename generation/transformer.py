...
class Seq2SeqModel(nn.Module):
    ...
    def __init__(self, args, dictionary):
        ...
        self.encoder = Encoder(len(dictionary),args.hidden_size,args.num_layers,args.enc_heads,args.enc_pf_dim, args.dropout_input, device= args.device)
        self.decoder = Decoder(len(dictionary),args.hidden_size,args.num_layers,args.dec_heads,args.dec_pf_dim, args.dropout_output, device= args.device)
